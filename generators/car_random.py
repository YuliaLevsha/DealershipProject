...
class CarRandom:
    ...
    def random_car_model(self) -> int:
        return random.randint(1, 10)

    def random_car_year(self) -> int:
        return random.randint(1990, 2020)

    def random_car_color(self) -> str:
        return random.choice(self.car_color)

    def random_car_number_of_doors(self) -> int:
        return random.randint(2, 5)

    def random_car_body_type(self) -> str:
        return random.choice(self.body_type)

    def random_car_type_drive(self) -> str:
        return random.choice(self.type_drive)

    def random_car_country(self) -> str:
        return random.choice(G8Countries.only)

    def random_car_volume_fuel_tank(self) -> int:
